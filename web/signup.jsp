            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                       ...
                       <li> <a href="core.html">Core Java</a></li>
						<li > <a href="advance.html">Advance Java</a></li>
...
<form action="RegisterServlet" >
                        ...
                        <div class="contact-form bottom">
                            ...
                            <div class="form-group">
                                Name:<input type="text" name="name" class="form-control" required="required" placeholder="Name">
                            </div>
                            <div class="form-group">
                                E-mail:<input type="email" name="email" class="form-control" required="required" placeholder="Email Id">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              Re-enter Password:<input type="password" name="re_password" class="form-control" required="required" placeholder="Password">
